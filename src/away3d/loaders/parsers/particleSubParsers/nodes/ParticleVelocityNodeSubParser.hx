...
class ParticleVelocityNodeSubParser extends ParticleNodeSubParserBase
{
    ...
    override private function proceedParsing() : Bool
    {
        if (_isFirstParsing)
        {
            var object : Dynamic = _data.velocity;
            ...
            _velocityValue = Type.createInstance(valueCls, [ParticleVelocityNode.VELOCITY_VECTOR3D]);
